        ...
        <div className='bg-gray-100 w-full'>
          ...
          <div className='max-w-[1300px] mx-auto bg-[white] py-12'>
            <div className='w-full px-2 lg:px-0 lg:w-3/4 mx-auto gap-8 flex flex-wrap align-center justify-center'>
              <div className="service shadow-xl flex flex-col align-left h-auto w-full lg:w-[250px] border-[1px] rounded p-4 border-gray-900 border-solid">
                <FontAwesomeIcon className='w-16 h-16 text-[#D08958]' icon={faStarOfLife} />
                <h3 className='text-2xl pt-4 text-[#D08958]'>Visa Consultation</h3>
              ...
              <div className="service shadow-xl flex flex-col align-left h-auto w-full lg:w-[250px] border-[1px] rounded p-4 border-gray-900 border-solid">
                <FontAwesomeIcon className='w-16 h-16 text-[#D08958]' icon={faMagnifyingGlass} />
                <h3 className='text-2xl pt-4 text-[#D08958]'>Document Verification and Preparation</h3>
                <p className='text-[15px]'>Assist clients in collecting and preparing the required documents for visa applications.</p>
              </div>
            
              <div className="service shadow-xl flex flex-col align-left h-auto w-full lg:w-[250px] border-[1px] rounded p-4 border-gray-900 border-solid">
                <FontAwesomeIcon className='w-16 h-16 text-[#D08958]' icon={faPen} />
                <h3 className='text-2xl pt-4 text-[#D08958]'>Application Submission</h3>
              ...
              <div className="service shadow-xl flex flex-col align-left h-auto w-full lg:w-[250px] border-[1px] rounded p-4 border-gray-900 border-solid">
                <FontAwesomeIcon className='w-16 h-16 text-[#D08958]' icon={faBook} />
                <h3 className='text-2xl pt-4 text-[#D08958]'>Case Assessment</h3>
              ...
              <div className="service shadow-xl flex flex-col align-left h-auto w-full lg:w-[250px] border-[1px] rounded p-4 border-gray-900 border-solid">
                <FontAwesomeIcon className='w-16 h-16 text-[#D08958]' icon={faEye} />
                <h3 className='text-2xl pt-4 text-[#D08958]'>Immigration Law and Policy Updates</h3>
              ...
              <div className="service shadow-xl flex flex-col align-left h-auto w-full lg:w-[250px] border-[1px] rounded p-4 border-gray-900 border-solid">
                <FontAwesomeIcon className='w-16 h-16 text-[#D08958]' icon={faCapsules} />
                <h3 className='text-2xl pt-4 text-[#D08958]'>Interview Preparation</h3>
              ...
              <div className="service shadow-xl flex flex-col align-left h-auto w-full lg:w-[250px] border-[1px] rounded p-4 border-gray-900 border-solid">
                <FontAwesomeIcon className='w-16 h-16 text-[#D08958]' icon={faStapler} />
                <h3 className='text-2xl pt-4 text-[#D08958]'>Appeals and Grievances</h3>
              ...
              <div className="service shadow-xl flex flex-col align-left h-auto w-full lg:w-[250px] border-[1px] rounded p-4 border-gray-900 border-solid">
                <FontAwesomeIcon className='w-16 h-16 text-[#D08958]' icon={faBusinessTime} />
                <h3 className='text-2xl pt-4 text-[#D08958]'>Corporate Immigration Services</h3>
              ...
              <div className="service shadow-xl flex flex-col align-left h-auto w-full lg:w-[250px] border-[1px] rounded p-4 border-gray-900 border-solid">
                <FontAwesomeIcon className='w-16 h-16 text-[#D08958]' icon={faPeopleRoof} />
                <h3 className='text-2xl pt-4 text-[#D08958]'>Family Immigration Services</h3>
              ...
              <div className="service shadow-xl flex flex-col align-left h-auto w-full lg:w-[250px] border-[1px] rounded p-4 border-gray-900 border-solid">
                <FontAwesomeIcon className='w-16 h-16 text-[#D08958]' icon={faClock} />
                <h3 className='text-2xl pt-4 text-[#D08958]'>Student Visa Services</h3>
              ...
              <div className="service shadow-xl flex flex-col align-left h-auto w-full lg:w-[250px] border-[1px] rounded p-4 border-gray-900 border-solid">
                <FontAwesomeIcon className='w-16 h-16 text-[#D08958]' icon={faUmbrellaBeach} />
                <h3 className='text-2xl pt-4 text-[#D08958]'>Travel Insurance Assistance</h3>
              ...
              <div className="service shadow-xl flex flex-col align-left h-auto w-full lg:w-[250px] border-[1px] rounded p-4 border-gray-900 border-solid">
                <FontAwesomeIcon className='w-16 h-16 text-[#D08958]' icon={faPeopleArrows} />
                <h3 className='text-2xl pt-4 text-[#D08958]'>Legal Compliance and Due Diligence</h3>
              ...
              <div className="service shadow-xl flex flex-col align-left h-auto w-full lg:w-[250px] border-[1px] rounded p-4 border-gray-900 border-solid">
                <FontAwesomeIcon className='w-16 h-16 text-[#D08958]' icon={faHandHoldingHeart} />
                <h3 className='text-2xl pt-4 text-[#D08958]'>Counseling Services</h3>
